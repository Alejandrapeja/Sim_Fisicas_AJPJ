...
int main() {
    ...
    //Creacion del joint Wheel

    b2WheelJointDef jointWeel;
    jointWeel.Initialize(cube.getBody(),cube2.getBody(),cube.getBody()->GetWorldCenter(),b2Vec2(0.0f,1.0f));
    world.CreateJoint(&jointWeel);
